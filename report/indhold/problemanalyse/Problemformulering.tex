...
\mbox{\parbox[b][2.5cm][c]{0.95\textwidth}{\textit{How can we develop a independent framework for creating simple multiplayer games - limiting the amount of time developers have to spent on writing code}}}
