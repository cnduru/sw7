\subsubsection{Admin}
\label{sec:adminimpl}
The Admin class handles requests from the client that can be classified as not game specific. \fixme{kunne være brugbart med metoder lidt mere beskrevet e.g. create game, hvordan handler den det? og hvad betyder handler her?}
