...
Another example could be a request for the games a particular Account is taking part in. With the account id as a parameter, the Data Mapper performs lookups in the game and player (plays relation in the ER diagram \Cref{fig:erdiagram}) tables, and then converts it to a list of games.
