\section{Test}
A number of tests were performed on the framework to inspect its response to stress, in particular with many simultaneously connected clients. The tests were black box tests\fixme{is this true?} and were devised to stress test all the APU calls visiable to the client.\\
