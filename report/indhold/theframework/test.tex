...
The tests were written as Python scripts, and can be found in the folder named Test with the rest of the source code.\fxfatal{ret i forhold til hvor det ligger} The test results can also be found \fxfatal{somewhere}.
...
The other script makes a single request a number\fxfatal{what number?} of times, collects the response delay for each request and finally calculates the mean and standard deviation.
